      ...
      <section className="w-full bg-white py-16 px-6">
        <div className="max-w-3xl mx-auto flex flex-col gap-8 text-sm text-gray-600 leading-relaxed">
          <div>
            ...
            <p>
              This is not the official website of CRC Group. It belongs to an
              authorised channel partner for CRC The Peridona, for information and
              marketing purposes only. All rights for logos and images are reserved
              by the developer, CRC Group.
            </p>
            <p className="mt-3">
          ...
          <div>
            ...
            <p>
              ...
              are advised to verify all details with the authorised sales team and with
              the UP RERA registration (UPRERAPRJ298067/05/2025, verifiable at
              www.up-rera.in) before making any decision.
            </p>
          </div>
