...
export default function EmiCalculator() {
  const [loan, setLoan] = useState(125000000);
  ...
  return (
    <section className="w-full bg-[#FAF8F4] flex flex-col items-center py-16 px-6 box-border">
      ...
      <div
        className="w-full max-w-[480px] bg-white p-6 rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.07)] transition-shadow duration-500 hover:shadow-[0_10px_40px_rgba(196,154,43,0.18)]"
        data-reveal="zoom"
      >
        <h3 className="text-[11px] font-bold tracking-[0.1em] uppercase mb-1 text-gray-900">
          EMI Calculator
        </h3>
        <p className="text-xs text-gray-400 mb-6">
          Plan your purchase at CRC The Peridona — tentative price ₹12.5 Cr* onwards
        </p>
        ...
        <div className="border-t border-gray-100 pt-4 mt-2">
          ...
          <div className="flex items-baseline gap-1.5">
            <span
              key={emi}
              className="animate-hero-fade-up text-[clamp(26px,6vw,36px)] font-bold text-[#2c1f0e]"
