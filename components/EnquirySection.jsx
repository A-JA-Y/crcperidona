...
export default function EnquirySection({
  logoSrc = logo,
  logoAlt = "CRC The Peridona",
  heading = "The Address of Abundance",
  body = "At CRC The Peridona, luxury isn't just built — it's beautifully lived. Set on 6.80 acres inside the 452-acre Jaypee Greens golf township, 7 towers rise 43 floors with just 341 ultra-luxury residences, each enjoying 2-side views of the Golf Course and the Nature Park. With the One Floor One Apartment* concept and private lift lobbies, every home by CRC Group is crafted around one promise — Live. More.",
}) {
 ...
 const handleSubmit = async (e) => {
  ...
  return (
    <section id="book-site-visit" className={`${theme.bg} relative w-full md:px-[30px] md:py-[45px] px-[25px] py-5 overflow-hidden`}>
      <div className="glow-blob -top-24 -right-24 w-[380px] h-[380px] opacity-30" />
      <div className="relative max-w-5xl mx-auto flex flex-col lg:flex-row lg:gap-16">
        {/* Left: Brand info */}
        <div className="flex flex-col gap-5 md:w-1/2" data-reveal="left">
          {/* Logo */}
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
                ...
                <div className="pt-1">
                  <button
                    ...
                    disabled={loading}
                    className={[
                      "btn-shine btn-gold-glow hover-lift inline-flex items-center gap-2 px-7 py-2.5 rounded bg-[#DCA54A] hover:bg-[#c8922a]",
                      theme.fontButton,
