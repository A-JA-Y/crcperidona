      ...
      <div className="flex flex-col m-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 pt-2">
          <div>
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              Ultra-luxury golf-facing residences at Jaypee Greens, Greater Noida by CRC Group.
            </p>
          </div>
        ...
        <div className="text-center mb-4">
          <p className="text-xs text-gray-400 leading-relaxed">
            Disclaimer : This is not the official website of CRC The Peridona or
            CRC Group; it belongs to an authorised channel partner for information
            & marketing purposes only. All rights for the logo & images are
            reserved by CRC Group. By using or accessing this website you agree
            with the disclaimer without any limitation. By accessing this website,
            ...
            making any booking/purchase in any project of the company.
          </p>
