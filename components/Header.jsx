...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="w-full shadow-md fixed top-0 left-0 right-0 z-30 bg-[#F0E6C5] lg:bg-[#fff] py-4">
                    ...
                    <div className="bg-white shadow-md rounded-md overflow-hidden">
                      {item.children.map((child) => (
                        <Link
                          ...
                          className="block px-4 py-2 text-[#D09A40] hover:text-[#DCA54A] whitespace-nowrap"
                        >
                          {child.label}
                        </Link>
                      ))}
