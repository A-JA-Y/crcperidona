...
const link = document.createElement("a");
  ...
  return (
    /* Backdrop */
    <div
      className="animate-overlay-fade fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-[2px] px-4"
      ...
      >
        ...
        <div className="pum-content popmake-content" tabIndex={0}>
          ...
          <h4 className="text-lg font-bold leading-snug mb-1">
            <mark className="bg-transparent text-[#c8952a]">
              Download CRC The Peridona - Brochure
            </mark>
          </h4>
          ...
          <div className="srfm-form-container">
            ...
            <div className="flex flex-col gap-[18px]">
              ...
              <button
                ...
                disabled={loading}
                id="srfm-submit-btn"
                className={`btn-shine btn-gold-glow hover-lift srfm-btn-frontend srfm-button srfm-submit-button bg-[#c8952a] hover:bg-[#b07d1f] text-white text-sm font-semibold tracking-widest uppercase px-6 py-3 rounded-md transition-colors duration-300 ${loading ? "opacity-70 cursor-not-allowed" : ""
                  }`}
              >
        ...
        <button
          ...
          className="
            ...
            hover:bg-gray-600 transition-all duration-300 hover:rotate-90 active:scale-90
            z-10
          "
        >
          X
